...
, function(t, e, n) {
    ...
    function mt(t) {
        ...
        u.default)(t, ["store", "computedStyle"]), c = o.element, s = o.actionItem, f = o.immediate, l = o.pluginInstance, d = o.continuous, p = o.restingValue, v = o.eventId, h = !d, g = P(), _ = r.getState(), I = _.ixElements, b = _.ixSession, T = _.ixData, w = C(I, c), O = (I[w] || {}).refState, A = y.getRefType(c), S = b.reducedMotion && E.ReducedMotionTypes[s.actionTypeId];
        if (S && d)
...
, function(t, e, n) {
    ...
    r.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            u && !s && (e = e || (n = t('').attr("href", ""),
            r = t("<img>").attr("src", "").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }),
            a = t("<img>").attr("src", "").attr("alt", "Made in Webflow"),
            n.append(r, a),
            n[0]),
            d(),
            setTimeout(d, 500),
...
, function(t, e, n) {
    ...
    function mt(t) {
        ...
        var R, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[b || w] || {}, D = Boolean(L.id || L.selector), P = o && l(gt(o.target));
...
, function(t, e, n) {
    ...
    var r = n(4)
      ...
      , b = function(t, e) {
        ...
        null == g && (E = 1,
        g = c);
        var m, _, I, b, T = Math.max(g, 0) || 0, w = v(T - n), O = l ? d : v(n + w * E), A = 100 * O;
        if (O === n && t.current)
            return t;
    ...
    "events": {
        ...
        "e-5": {
            ...
            "target": {
                ...
                "originalId": "5f885a022bec3957c5bfaecc|2ec42036-e94c-a420-8b3f-49e06453d051",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".toogle-questions",
